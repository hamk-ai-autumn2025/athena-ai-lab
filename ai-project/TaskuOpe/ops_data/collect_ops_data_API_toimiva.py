...
# ======================================================================
# === UUSI LOGIIKKA: SÄILYTETTÄVIEN OPPIAINEIDEN LISTA ("WHITELIST") ====
# ======================================================================
...
def collect_from_context(ctx: Dict[str, Any], subject_label: str, grade_context_label: str, results: List[Dict[str, Any]]) -> Tuple[int, int, int]:
    g_cnt = c_cnt = e_cnt = 0
    goals_list: List[Any] = []
...
def process_subject(detail_json: Dict[str, Any], base_name: str, results: List[Dict[str, Any]], inherited_grade_label: str = "") -> Tuple[int, int, int]:
